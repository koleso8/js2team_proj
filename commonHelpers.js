import{A as R,S as x,N as L,K as P,M,a as $,b as z,c as Y}from"./assets/vendor-f702467a.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))l(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&l(a)}).observe(document,{childList:!0,subtree:!0});function s(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function l(i){if(i.ep)return;i.ep=!0;const o=s(i);fetch(i.href,o)}})();const B=R.create({baseURL:"https://portfolio-js.b.goit.study/api"});async function Q(){return(await B.get("/reviews")).data}async function D(e){return(await B.post("/requests",e)).data}const d="/js2team_proj/assets/icons-6e183fea.svg";x.use([L,P,M]);const I={accordionContainerEl:document.querySelector(".about-me-accordion-container"),swiperWrapperEl:document.querySelector(".swiper-wrapper")},J=[{title:"About me",textFirst:"I am Lloyd Jefferson, a talented programmer with extensive expertise in software development. I have an understanding of different programming languages and technologies, always ready to improve my skills. I always follow the latest trends and look for unconventional, creative solutions to problems. I have a high level of analytical skills and am able to effectively solve even the most difficult tasks encountered on the way.",textSecond:"Able to work both independently and in a team.I can effectively cooperate with colleagues, exchanging ideas and finding optimal solutions.Professional maturity allows you to calmly cope with challenges and stressful situations, while maintaining a high quality of work.I am always looking for opportunities for self - improvement.I actively study new technologies and practices to stay abreast of the latest innovations.I have a strong understanding of various programming languages, frameworks and architectural concepts that allow me to create efficient and scalable software."},{title:"Role",textFirst:"Frontend development",textSecond:"HeadlessCMS, Wordpress",textThird:"Blender(enjoy)"},{title:"Education",textFirst:"2018 - 2019  / Frontend Development Diploma, GoIT IT School, New York ",textSecond:"2019 - 2020 / Advanced Web Development Certificate, GoIT IT School, New York",textThird:"2020 - 2022 / Advanced Blender Animation Techniques, Udemy"}],U=["HTML / CSS","JavaScript","React","Node. js","React Native","Soft skills","Python"];function V(e){return e.map(t=>`
  <li class="ac" id="about-ac">
    ...
    <div class="swiper-slide">${t}</div>
        `).join("")}function G(){const e=F(U);I.swiperWrapperEl.innerHTML=e}G();const u=new x(".about-skills-swiper",{modules:[L,P,M],navigation:{nextEl:".about-swiper-button-next",grabCursor:!0},keyboard:{enabled:!0,onlyInViewport:!0},mousewheel:{invert:!1,sensitivity:1,eventsTarget:".about-skills-swiper"},breakpoints:{375:{slidesPerView:2},768:{slidesPerView:3},1440:{slidesPerView:6}},loop:!0,setWrapperSize:!0,spaceBetween:0,speed:1e3,simulateTouch:!1,slideToClickedSlide:!0,slidesPerGroup:1,grabCursor:!0});function q(){const e=u.slides;e.forEach(s=>s.classList.remove("is-first")),e[u.activeIndex].classList.add("is-first")}document.addEventListener("keydown",e=>{e.key==="Tab"?(e.preventDefault(),u.slideNext(1e3)):e.key==="Shift"&&(e.preventDefault(),u.slidePrev(1e3))});u.update();u.on("slideChange",q);u.on("slideChangeTransitionEnd",q);q();const X="/js2team_proj/assets/1@2х-a357cafa.webp",Z="/js2team_proj/assets/1_1x-8af67d25.webp",ee="/js2team_proj/assets/4@2х-1e0e78b9.webp",te="/js2team_proj/assets/4_1x-32ae2e13.webp",se="/js2team_proj/assets/5@2х-09b0daa2.webp",ie="/js2team_proj/assets/5_1x-6c94befd.webp",oe="/js2team_proj/assets/6@2х-0ae99116.webp",ne="/js2team_proj/assets/6_1x-2d387991.webp",ae="/js2team_proj/assets/7@2х-255834f3.webp",ce="/js2team_proj/assets/7_1x-0e407f1a.webp",le="/js2team_proj/assets/8@2х-563f898c.webp",re="/js2team_proj/assets/8_1x-cddca86a.webp",de="/js2team_proj/assets/9@2х-286a2bd3.webp",ue="/js2team_proj/assets/9_1x-12803bfe.webp",me="/js2team_proj/assets/10@2х-b2cb52f1.webp",pe="/js2team_proj/assets/10_1x-d251b59b.webp",be="/js2team_proj/assets/11@2х-7955e579.webp",he="/js2team_proj/assets/11_1x-0361553e.webp",ge="/js2team_proj/assets/12@2х-b67bfe9b.webp",fe="/js2team_proj/assets/12_1x-b047004f.webp";let xe=[Z,X,te,ee,ie,se,ne,oe,ce,ae,re,le,ue,de,pe,me,he,be,fe,ge];function we(e){return`
       <div class="marquee">
  ...
  <span class="mob-menu-close-btn-line mob-menu-close-btn-line2"></span>
    ...
    `,{onShow:t=>{const s=t.element().querySelectorAll("a");t.element().querySelector(".mob-menu-backdrop").addEventListener("click",()=>{t.close()}),s.forEach(o=>{o.addEventListener("click",a=>{a.preventDefault();const m=document.querySelector(o.getAttribute("href"));m&&m.scrollIntoView({behavior:"smooth"}),t.close()})});const i=t.element().querySelector(".mob-order-btn");i&&i.addEventListener("click",o=>{o.preventDefault();const a=document.querySelector(i.getAttribute("href"));a&&a.scrollIntoView({behavior:"smooth"}),t.close()})}}).show()}const _e="/js2team_proj/assets/image_1_mob@1x-89b2e206.webp",Ae="/js2team_proj/assets/image_1_mob@2x-999825f4.webp",Ee="/js2team_proj/assets/image_1_tab_desk@1x-90b1035f.webp",Se="/js2team_proj/assets/image_1_tab_desk@2x-25537a1a.webp",Te="/js2team_proj/assets/image_2_mob@1x-29b35221.webp",Pe="/js2team_proj/assets/image_2_mob@2x-4a031e92.webp",Me="/js2team_proj/assets/image_2_tab_desk@1x-f2489662.webp",$e="/js2team_proj/assets/image_2_tab_desk@2x-0e0ab3ec.webp",ze="data:image/webp;base64,",Be="/js2team_proj/assets/image_3_mob@2x-f08587ef.webp",Ie="/js2team_proj/assets/image_3_tab_desk@1x-c6b16f91.webp",Ce="/js2team_proj/assets/image_3_tab_desk@2x-c6650a6e.webp",n={project1_mob1x:_e,project1_mob2x:Ae,project1_tab1x:Ee,project1_tab2x:Se,project2_mob1x:Te,project2_mob2x:Pe,project2_tab1x:Me,project2_tab2x:$e,project3_mob1x:ze,project3_mob2x:Be,project3_tab1x:Ie,project3_tab2x:Ce},Ne=[{skill1:"&num;react",skill2:"&num;js",skill3:"&num;node js",skill4:"&num;git",title:"Programming Across Borders: Ideas, Technologies, Innovations",href:"https://github.com/koleso8/js2team_proj",link:"See project",imgMob1:n.project1_mob1x,imgMob2:n.project1_mob2x,imgTab1:n.project1_tab1x,imgTab2:n.project1_tab2x},{skill1:"&num;react",skill2:"&num;js",skill3:"&num;node js",skill4:"&num;git",title:"Programming Across Borders: Ideas, Technologies, Innovations",href:"https://github.com/koleso8/js2team_proj",link:"See project",imgMob1:n.project2_mob1x,imgMob2:n.project2_mob2x,imgTab1:n.project2_tab1x,imgTab2:n.project2_tab2x},{skill1:"&num;react",skill2:"&num;js",skill3:"&num;node js",skill4:"&num;git",title:"Programming Across Borders: Ideas, Technologies, Innovations",href:"https://github.com/koleso8/js2team_proj",link:"See project",imgMob1:n.project3_mob1x,imgMob2:n.project3_mob2x,imgTab1:n.project3_tab1x,imgTab2:n.project3_tab2x}],Oe=document.querySelector(".projects-cards"),v=document.querySelector(".swiper-button-prev"),y=document.querySelector(".swiper-button-next"),A=document.querySelector(".icon-prev"),E=document.querySelector(".icon-next");function We(e){return e.map(t=>`<li class="projects-card swiper-slide">
        ...
        </li>`).join("")}function He(e){const t=We(e);Oe.innerHTML=t}He(Ne);document.addEventListener("DOMContentLoaded",()=>{const e=new x(".swiper-container",{slidesPerView:1,spaceBetween:20,grabCursor:!0});function t(){e.isBeginning?(v.classList.add("disabled"),A.classList.add("disabled")):(v.classList.remove("disabled"),A.classList.remove("disabled")),e.isEnd?(y.classList.add("disabled"),E.classList.add("disabled")):(y.classList.remove("disabled"),E.classList.remove("disabled"))}y.addEventListener("click",()=>{e.slideNext(1e3)}),v.addEventListener("click",()=>{e.slidePrev(1e3)}),document.addEventListener("keydown",s=>{s.key==="ArrowRight"?e.slideNext(1e3):s.key==="ArrowLeft"?e.slidePrev(1e3):s.key==="Tab"&&(s.preventDefault(),s.shiftKey?e.slidePrev(1e3):e.slideNext(1e3))}),e.on("slideChange",t),t()});const Re=document.querySelector(".reviews-list");async function Ye(){try{const e=await Q();Qe(e)}catch{throw new Error("Not found")}}Ye();function Qe(e){const t=e.map(s=>`<li class="reviews-item swiper-slide">
          <img src="${s.avatar_url}" alt="${s.author}"/>
          <h3>${s.author}</h3>
          <p>${s.review}</p>
        </li>`).join("");Re.insertAdjacentHTML("beforeend",t)}new x(".reviews-swiper",{modules:[L,Y],speed:500,navigation:{nextEl:".reviews-swiper-button-next",prevEl:".reviews-swiper-button-prev"},slidesPerView:1,breakpoints:{768:{slidesPerView:2,spaceBetween:16},1440:{slidesPerView:4,spaceBetween:16}}});const De=z.create(`
     <div class="container">
     <div class="modal">
...
`,{onShow:e=>{e.element().querySelector("a").onclick=e.close,document.addEventListener("keydown",t=>{t.code==="Escape"&&e.close()}),document.body.style.position="fixed"},onClose:e=>{console.log("onClose",e),document.body.style.position=""}});function Je(){return De.show()}const f=document.querySelector(".form"),j=document.querySelector(".comments"),S=document.querySelector(".email");f.addEventListener("submit",async e=>{e.preventDefault();const t=f.elements.email.value.trim(),s=f.elements.comments.value.trim();await D({email:t,comment:s}),Je(),f.reset()});j.addEventListener("input",()=>{const e=j.value.slice(0,150).replace("...","");e.length>=150&&(j.value=e+"...")});S.addEventListener("input",()=>{const e=S.value;e.validity.valid?(e.classList.add("valid"),e.classList.remove("invalid")):(e.classList.add("invalid"),e.classList.remove("valid"))});document.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",function(t){t.preventDefault();const s=document.querySelector(this.getAttribute("href"));if(s){let _=function(c){m===null&&(m=c);const p=c-m,g=W(p,i,o,a);window.scrollTo(0,g),p<a&&requestAnimationFrame(_)},W=function(c,p,g,H){return c/=H/2,c<1?g/2*c*c+p:(c--,-g/2*(c*(c-2)-1)+p)};const l=s.getBoundingClientRect().top+window.pageYOffset,i=window.pageYOffset,o=l-i,a=500;let m=null;requestAnimationFrame(_)}})});let Ue=document.querySelectorAll(".section-animation");function N(){let e=window.innerHeight;Ue.forEach(t=>{t.getBoundingClientRect().top<e-100?(t.style.opacity="1",t.style.transform="translateY(0)"):(t.style.opacity="0",t.style.transform="translateY(0)")})}N();window.addEventListener("scroll",N);const Ve={listEl:document.querySelector(".benefits-list")},Ke=[{svg:`${d}#user`,title:"Expertise",text:"As a highly experienced developer, I have deep knowledge of programming and website development."},{svg:`${d}#message`,title:"Communication",text:" Understanding your needs and wants is my priority and I am always open to discussions and corrections."},{svg:`${d}#brush`,title:"Art",text:"Thanks to my creative nature, I am ready to accept challenges and help you bring your ideas to life. "},{svg:`${d}#hourglass`,title:"Urgent execution",text:"I understand how important time is to you. Ready to work quickly and efficiently, without reducing the quality of work."}];function Fe(e){const t=e.svg,s=e.title,l=e.text;return`<li class="benefits-list-item">
        <span class="bg-icon">
      ...
      </li>`}function Ge(e){return e.map(Fe).join("")}function Xe(e){const t=Ge(e);Ve.listEl.insertAdjacentHTML("beforeend",t)}Xe(Ke);const b=await VANTA.NET({mouseControls:!0,touchControls:!0,gyroControls:!0,minHeight:200,minWidth:200,scale:1,scaleMobile:1,maxDistance:25,el:"#animation-box",color:15547204,backgroundColor:1842464});function Ze(){b.setOptions({color:15547204})}function et(){b.setOptions({color:13034279})}function tt(){b.setOptions({color:16744200})}function st(){b.setOptions({color:2835521})}function it(){b.setOptions({color:16872})}const ot=document.querySelector(".theme-red"),nt=document.querySelector(".theme-yellow"),at=document.querySelector(".theme-orange"),ct=document.querySelector(".theme-green"),lt=document.querySelector(".theme-blue"),T=document.querySelector("body"),k=document.querySelector(".choose-theme-btn"),O=document.querySelector(".theme-buttons");function h(e){T.classList="",T.classList.add(e),k.classList.remove("hidden"),O.classList.add("hidden")}ot.addEventListener("click",()=>{h("red"),Ze()});nt.addEventListener("click",()=>{h("yellow"),et()});at.addEventListener("click",()=>{h("orange"),tt()});ct.addEventListener("click",()=>{h("green"),st()});lt.addEventListener("click",()=>{h("blue"),it()});k.addEventListener("click",()=>{O.classList.remove("hidden"),k.classList.add("hidden")});
