import{A as h,a as y,b as v}from"./assets/vendor-c4f2e476.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function i(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=i(o);fetch(o.href,s)}})();h.create({baseURL:"https://portfolio-js.b.goit.study/api"});const b={listEl:document.querySelector(".benefits-list")},x=[{svg:"images/svg/icons.svg#user",title:"Expertise",text:"As a highly experienced developer, I have deep knowledge of programming and website development."},{svg:"images/svg/icons.svg#message",title:"Communication",text:" Understanding your needs and wants is my priority and I am always open to discussions and corrections."},{svg:"images/svg/icons.svg#brush",title:"Art",text:"Thanks to my creative nature, I am ready to accept challenges and help you bring your ideas to life. "},{svg:"images/svg/icons.svg#hourglass",title:"Urgent execution",text:"I understand how important time is to you. Ready to work quickly and efficiently, without reducing the quality of work."}];function w(e){const t=e.svg,i=e.title,a=e.text;return`<li class="benefits-list-item">
        <span class="bg-icon">
    ...
    `}function O(e){return e.map(P).join("")}function C(e){const t=O(e);q.listEl.insertAdjacentHTML("afterbegin",t)}C(I);new y(".accordion-container",{});v.create(`
     <div class="container">
     <div class="modal">
...
`,{onShow:e=>{e.element().querySelector("a").onclick=e.close,document.addEventListener("keydown",t=>{t.code==="Escape"&&e.close()}),document.body.style.position="fixed"},onClose:e=>{console.log("onClose",e),document.body.style.position=""}});document.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",function(t){t.preventDefault();const i=document.querySelector(this.getAttribute("href"));if(i){let f=function(n){d===null&&(d=n);const c=n-d,l=p(c,o,s,r);window.scrollTo(0,l),c<r&&requestAnimationFrame(f)},p=function(n,c,l,g){return n/=g/2,n<1?l/2*n*n+c:(n--,-l/2*(n*(n-2)-1)+c)};const a=i.getBoundingClientRect().top+window.pageYOffset,o=window.pageYOffset,s=a-o,r=500;let d=null;requestAnimationFrame(f)}})});let S=document.querySelectorAll(".section-animation");function m(){let e=window.innerHeight;S.forEach(t=>{t.getBoundingClientRect().top<e-100&&(t.style.opacity="1",t.style.transform="translateY(0)")})}m();window.addEventListener("scroll",m);const D={themeList:document.querySelector(".theme-list")};D.themeList.addEventListener("click",e=>{switch(console.log(e.target.dataset.action),e.target.dataset.action){case"red":return L();case"yellow":return T();case"orange":return j()}});
