import{A as m,a as g,b as y}from"./assets/vendor-c4f2e476.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function n(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=n(o);fetch(o.href,s)}})();m.create({baseURL:"https://portfolio-js.b.goit.study/api"});const v={listEl:document.querySelector(".benefits-list")},b=[{svg:"../svg/icons.svg#user",title:"Expertise",text:"As a highly experienced developer, I have deep knowledge of programming and website development."},{svg:"../svg/icons.svg#message",title:"Communication",text:" Understanding your needs and wants is my priority and I am always open to discussions and corrections."},{svg:"../svg/icons.svg#brush",title:"Art",text:"Thanks to my creative nature, I am ready to accept challenges and help you bring your ideas to life. "},{svg:"../svg/icons.svg#hourglass",title:"Urgent execution",text:"I understand how important time is to you. Ready to work quickly and efficiently, without reducing the quality of work."}];function w(e){const t=e.svg,n=e.title,a=e.text;return`<li class="benefits-list-item">
        <span class="bg-icon">
    ...
    `}function q(e){return e.map(T).join("")}function L(e){const t=q(e);k.listEl.insertAdjacentHTML("afterbegin",t)}L(E);new g(".accordion-container",{});y.create(`
     <div class="container">
     <div class="modal">
...
`,{onShow:e=>{e.element().querySelector("a").onclick=e.close,document.addEventListener("keydown",t=>{t.code==="Escape"&&e.close()}),document.body.style.position="fixed"},onClose:e=>{console.log("onClose",e),document.body.style.position=""}});document.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",function(t){t.preventDefault();const n=document.querySelector(this.getAttribute("href"));if(n){let u=function(i){d===null&&(d=i);const c=i-d,l=p(c,o,s,r);window.scrollTo(0,l),c<r&&requestAnimationFrame(u)},p=function(i,c,l,h){return i/=h/2,i<1?l/2*i*i+c:(i--,-l/2*(i*(i-2)-1)+c)};const a=n.getBoundingClientRect().top+window.pageYOffset,o=window.pageYOffset,s=a-o,r=500;let d=null;requestAnimationFrame(u)}})});let A=document.querySelectorAll(".section-animation");function f(){let e=window.innerHeight;A.forEach(t=>{t.getBoundingClientRect().top<e-100&&(t.style.opacity="1",t.style.transform="translateY(0)")})}f();window.addEventListener("scroll",f);
