import{A as C,S as f,N as _,K as A,M as q,a as S,b as T}from"./assets/vendor-407bd766.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function i(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(s){if(s.ep)return;s.ep=!0;const o=i(s);fetch(s.href,o)}})();C.create({baseURL:"https://portfolio-js.b.goit.study/api"});const d="/js2team_proj/assets/icons-6e183fea.svg";f.use([_,A,q]);const E={accordionContainerEl:document.querySelector(".about-me-accordion-container"),swiperWrapperEl:document.querySelector(".swiper-wrapper")},I=[{title:"About me",textFirst:"I am Lloyd Jefferson, a talented programmer with extensive expertise in software development. I have an understanding of different programming languages and technologies, always ready to improve my skills. I always follow the latest trends and look for unconventional, creative solutions to problems. I have a high level of analytical skills and am able to effectively solve even the most difficult tasks encountered on the way.",textSecond:"Able to work both independently and in a team.I can effectively cooperate with colleagues, exchanging ideas and finding optimal solutions.Professional maturity allows you to calmly cope with challenges and stressful situations, while maintaining a high quality of work.I am always looking for opportunities for self - improvement.I actively study new technologies and practices to stay abreast of the latest innovations.I have a strong understanding of various programming languages, frameworks and architectural concepts that allow me to create efficient and scalable software."},{title:"Role",textFirst:"Frontend development",textSecond:"HeadlessCMS, Wordpress",textThird:"Blender(enjoy)"},{title:"Education",textFirst:"2018 - 2019  / Frontend Development Diploma, GoIT IT School, New York ",textSecond:"2019 - 2020 / Advanced Web Development Certificate, GoIT IT School, New York",textThird:"2020 - 2022 / Advanced Blender Animation Techniques, Udemy"}],N=["HTML / CSS","JavaScript","React","Node. js","React Native","Soft skills","Python"];function B(e){return e.map(t=>`
  ...
  <span class="mob-menu-close-btn-line mob-menu-close-btn-line2"></span>
    ...
    `,{onShow:t=>{const i=t.element().querySelectorAll("a");t.element().querySelector(".mob-menu-backdrop").addEventListener("click",()=>{t.close()}),i.forEach(o=>{o.addEventListener("click",c=>{c.preventDefault();const p=document.querySelector(o.getAttribute("href"));p&&p.scrollIntoView({behavior:"smooth"}),t.close()})});const s=t.element().querySelector(".mob-order-btn");s&&s.addEventListener("click",o=>{o.preventDefault();const c=document.querySelector(s.getAttribute("href"));c&&c.scrollIntoView({behavior:"smooth"}),t.close()})}}).show()}const Te="/js2team_proj/assets/image_1_mob@1x-89b2e206.webp",Ee="/js2team_proj/assets/image_1_mob@2x-999825f4.webp",Pe="/js2team_proj/assets/image_1_tab_desk@1x-90b1035f.webp",Me="/js2team_proj/assets/image_1_tab_desk@2x-25537a1a.webp",$e="/js2team_proj/assets/image_2_mob@1x-29b35221.webp",ze="/js2team_proj/assets/image_2_mob@2x-4a031e92.webp",Ce="/js2team_proj/assets/image_2_tab_desk@1x-f2489662.webp",Ie="/js2team_proj/assets/image_2_tab_desk@2x-0e0ab3ec.webp",Ne="data:image/webp;base64,",Be="/js2team_proj/assets/image_3_mob@2x-f08587ef.webp",We="/js2team_proj/assets/image_3_tab_desk@1x-c6b16f91.webp",Oe="/js2team_proj/assets/image_3_tab_desk@2x-c6650a6e.webp",a={project1_mob1x:Te,project1_mob2x:Ee,project1_tab1x:Pe,project1_tab2x:Me,project2_mob1x:$e,project2_mob2x:ze,project2_tab1x:Ce,project2_tab2x:Ie,project3_mob1x:Ne,project3_mob2x:Be,project3_tab1x:We,project3_tab2x:Oe},He=[{skill1:"&num;react",skill2:"&num;js",skill3:"&num;node js",skill4:"&num;git",title:"Programming Across Borders: Ideas, Technologies, Innovations",href:"https://github.com/koleso8/js2team_proj",link:"See project",imgMob1:a.project1_mob1x,imgMob2:a.project1_mob2x,imgTab1:a.project1_tab1x,imgTab2:a.project1_tab2x},{skill1:"&num;react",skill2:"&num;js",skill3:"&num;node js",skill4:"&num;git",title:"Programming Across Borders: Ideas, Technologies, Innovations",href:"https://github.com/koleso8/js2team_proj",link:"See project",imgMob1:a.project2_mob1x,imgMob2:a.project2_mob2x,imgTab1:a.project2_tab1x,imgTab2:a.project2_tab2x},{skill1:"&num;react",skill2:"&num;js",skill3:"&num;node js",skill4:"&num;git",title:"Programming Across Borders: Ideas, Technologies, Innovations",href:"https://github.com/koleso8/js2team_proj",link:"See project",imgMob1:a.project3_mob1x,imgMob2:a.project3_mob2x,imgTab1:a.project3_tab1x,imgTab2:a.project3_tab2x}],Qe=document.querySelector(".projects-cards"),b=document.querySelector(".swiper-button-prev"),w=document.querySelector(".swiper-button-next"),k=document.querySelector(".icon-prev"),L=document.querySelector(".icon-next");function Ye(e){return e.map(t=>`<li class="projects-card swiper-slide">
        ...
        </li>`).join("")}function Re(e){const t=Ye(e);Qe.innerHTML=t}Re(He);document.addEventListener("DOMContentLoaded",()=>{const e=new f(".swiper-container",{slidesPerView:1,spaceBetween:20,grabCursor:!0});function t(){e.isBeginning?(b.classList.add("disabled"),k.classList.add("disabled")):(b.classList.remove("disabled"),k.classList.remove("disabled")),e.isEnd?(w.classList.add("disabled"),L.classList.add("disabled")):(w.classList.remove("disabled"),L.classList.remove("disabled"))}w.addEventListener("click",()=>{e.slideNext(1e3)}),b.addEventListener("click",()=>{e.slidePrev(1e3)}),document.addEventListener("keydown",i=>{i.key==="ArrowRight"?e.slideNext(1e3):i.key==="ArrowLeft"?e.slidePrev(1e3):i.key==="Tab"&&(i.preventDefault(),i.shiftKey?e.slidePrev(1e3):e.slideNext(1e3))}),e.on("slideChange",t),t()});T.create(`
     <div class="container">
     <div class="modal">
...
`,{onShow:e=>{e.element().querySelector("a").onclick=e.close,document.addEventListener("keydown",t=>{t.code==="Escape"&&e.close()}),document.body.style.position="fixed"},onClose:e=>{console.log("onClose",e),document.body.style.position=""}});document.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",function(t){t.preventDefault();const i=document.querySelector(this.getAttribute("href"));if(i){let y=function(l){p===null&&(p=l);const u=l-p,h=$(u,s,o,c);window.scrollTo(0,h),u<c&&requestAnimationFrame(y)},$=function(l,u,h,z){return l/=z/2,l<1?h/2*l*l+u:(l--,-h/2*(l*(l-2)-1)+u)};const n=i.getBoundingClientRect().top+window.pageYOffset,s=window.pageYOffset,o=n-s,c=500;let p=null;requestAnimationFrame(y)}})});let De=document.querySelectorAll(".section-animation");function M(){let e=window.innerHeight;De.forEach(t=>{t.getBoundingClientRect().top<e-100?(t.style.opacity="1",t.style.transform="translateY(0)"):(t.style.opacity="0",t.style.transform="translateY(0)")})}M();window.addEventListener("scroll",M);const Je={themeList:document.querySelector(".theme-list")};Je.themeList.addEventListener("click",e=>{switch(console.log(e.target.dataset.action),e.target.dataset.action){case"red":return U();case"yellow":return V();case"orange":return K()}});
