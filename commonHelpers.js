import{A as I,S as v,N as q,K as A,M as S,a as E,b as T}from"./assets/vendor-407bd766.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function i(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=i(s);fetch(s.href,o)}})();I.create({baseURL:"https://portfolio-js.b.goit.study/api"});const d="/js2team_proj/assets/icons-6e183fea.svg";v.use([q,A,S]);const P={accordionContainerEl:document.querySelector(".about-me-accordion-container"),swiperWrapperEl:document.querySelector(".swiper-wrapper")},N=[{title:"About me",textFirst:"I am Lloyd Jefferson, a talented programmer with extensive expertise in software development. I have an understanding of different programming languages and technologies, always ready to improve my skills. I always follow the latest trends and look for unconventional, creative solutions to problems. I have a high level of analytical skills and am able to effectively solve even the most difficult tasks encountered on the way.",textSecond:"Able to work both independently and in a team.I can effectively cooperate with colleagues, exchanging ideas and finding optimal solutions.Professional maturity allows you to calmly cope with challenges and stressful situations, while maintaining a high quality of work.I am always looking for opportunities for self - improvement.I actively study new technologies and practices to stay abreast of the latest innovations.I have a strong understanding of various programming languages, frameworks and architectural concepts that allow me to create efficient and scalable software."},{title:"Role",textFirst:"Frontend development",textSecond:"HeadlessCMS, Wordpress",textThird:"Blender(enjoy)"},{title:"Education",textFirst:"2018 - 2019  / Frontend Development Diploma, GoIT IT School, New York ",textSecond:"2019 - 2020 / Advanced Web Development Certificate, GoIT IT School, New York",textThird:"2020 - 2022 / Advanced Blender Animation Techniques, Udemy"}],B=["HTML / CSS","JavaScript","React","Node. js","React Native","Soft skills","Python"];function O(e){return e.map(t=>`
  <li class="ac" id="about-ac">
    ...
    <div class="swiper-slide">${t}</div>
      ...
      </li>`}function J(e){return e.map(D).join("")}function U(e){const t=J(e);Q.listEl.insertAdjacentHTML("beforeend",t)}U(R);const b=VANTA.NET({mouseControls:!0,touchControls:!0,gyroControls:!0,minHeight:200,minWidth:200,scale:1,scaleMobile:1,maxDistance:25,el:"#animation-box",color:15547204,backgroundColor:1842464});function V(){b.setOptions({color:15547204})}function K(){b.setOptions({color:13034279})}function F(){b.setOptions({color:16744200})}function G(){b.setOptions({color:2835521})}function X(){b.setOptions({color:16872})}const Z="/js2team_proj/assets/1@2х-a357cafa.webp",ee="/js2team_proj/assets/1_1x-8af67d25.webp",te="/js2team_proj/assets/4@2х-1e0e78b9.webp",se="/js2team_proj/assets/4_1x-32ae2e13.webp",ie="/js2team_proj/assets/5@2х-09b0daa2.webp",oe="/js2team_proj/assets/5_1x-6c94befd.webp",ae="/js2team_proj/assets/6@2х-0ae99116.webp",ne="/js2team_proj/assets/6_1x-2d387991.webp",ce="/js2team_proj/assets/7@2х-255834f3.webp",le="/js2team_proj/assets/7_1x-0e407f1a.webp",re="/js2team_proj/assets/8@2х-563f898c.webp",de="/js2team_proj/assets/8_1x-cddca86a.webp",ue="/js2team_proj/assets/9@2х-286a2bd3.webp",me="/js2team_proj/assets/9_1x-12803bfe.webp",pe="/js2team_proj/assets/10@2х-b2cb52f1.webp",be="/js2team_proj/assets/10_1x-d251b59b.webp",ge="/js2team_proj/assets/11@2х-7955e579.webp",he="/js2team_proj/assets/11_1x-0361553e.webp",xe="/js2team_proj/assets/12@2х-b67bfe9b.webp",fe="/js2team_proj/assets/12_1x-b047004f.webp";let we=[ee,Z,se,te,oe,ie,ne,ae,le,ce,de,re,me,ue,be,pe,he,ge,fe,xe];function ve(e){return`
       <div class="marquee">
    ...
    `}function Le(e){return e.map(ke).join("")}function _e(e){const t=Le(e);ye.listEl.insertAdjacentHTML("afterbegin",t)}_e(je);new E(".accordion-container",{});const l={deskMenuBtn:document.querySelector(".desk-menu-btn"),deskMenu:document.querySelector(".desk-menu"),deskMenuBox:document.querySelector(".desk-menu-box"),header:document.querySelector(".header"),mobMenuBtn:document.querySelector(".mob-menu-btn"),mobMenuBackdrop:document.querySelector(".mob-menu-backdrop")};function M(){l.deskMenu.classList.add("visually-hidden")}l.deskMenuBtn.addEventListener("click",()=>{l.deskMenu.classList.toggle("visually-hidden")});l.deskMenu.addEventListener("click",e=>{e.target.tagName==="A"&&M()});document.addEventListener("click",e=>{l.deskMenuBox.contains(e.target)||M()});let x=0;window.addEventListener("scroll",()=>{const e=window.scrollY||document.documentElement.scrollTop;e>x?l.header.classList.add("hidden"):e<x&&l.header.classList.remove("hidden"),x=e});l.mobMenuBtn.addEventListener("click",qe);function qe(){T.create(`
  ...
  <span class="mob-menu-close-btn-line mob-menu-close-btn-line2"></span>
    ...
    `,{onShow:t=>{const i=t.element().querySelectorAll("a");t.element().querySelector(".mob-menu-backdrop").addEventListener("click",()=>{t.close()}),i.forEach(o=>{o.addEventListener("click",n=>{n.preventDefault();const m=document.querySelector(o.getAttribute("href"));m&&m.scrollIntoView({behavior:"smooth"}),t.close()})});const s=t.element().querySelector(".mob-order-btn");s&&s.addEventListener("click",o=>{o.preventDefault();const n=document.querySelector(s.getAttribute("href"));n&&n.scrollIntoView({behavior:"smooth"}),t.close()})}}).show()}const Ae="/js2team_proj/assets/image_1_mob@1x-89b2e206.webp",Se="/js2team_proj/assets/image_1_mob@2x-999825f4.webp",Ee="/js2team_proj/assets/image_1_tab_desk@1x-90b1035f.webp",Te="/js2team_proj/assets/image_1_tab_desk@2x-25537a1a.webp",Pe="/js2team_proj/assets/image_2_mob@1x-29b35221.webp",Me="/js2team_proj/assets/image_2_mob@2x-4a031e92.webp",$e="/js2team_proj/assets/image_2_tab_desk@1x-f2489662.webp",ze="/js2team_proj/assets/image_2_tab_desk@2x-0e0ab3ec.webp",Ce="data:image/webp;base64,",Ie="/js2team_proj/assets/image_3_mob@2x-f08587ef.webp",Ne="/js2team_proj/assets/image_3_tab_desk@1x-c6b16f91.webp",Be="/js2team_proj/assets/image_3_tab_desk@2x-c6650a6e.webp",a={project1_mob1x:Ae,project1_mob2x:Se,project1_tab1x:Ee,project1_tab2x:Te,project2_mob1x:Pe,project2_mob2x:Me,project2_tab1x:$e,project2_tab2x:ze,project3_mob1x:Ce,project3_mob2x:Ie,project3_tab1x:Ne,project3_tab2x:Be},Oe=[{skill1:"&num;react",skill2:"&num;js",skill3:"&num;node js",skill4:"&num;git",title:"Programming Across Borders: Ideas, Technologies, Innovations",href:"https://github.com/koleso8/js2team_proj",link:"See project",imgMob1:a.project1_mob1x,imgMob2:a.project1_mob2x,imgTab1:a.project1_tab1x,imgTab2:a.project1_tab2x},{skill1:"&num;react",skill2:"&num;js",skill3:"&num;node js",skill4:"&num;git",title:"Programming Across Borders: Ideas, Technologies, Innovations",href:"https://github.com/koleso8/js2team_proj",link:"See project",imgMob1:a.project2_mob1x,imgMob2:a.project2_mob2x,imgTab1:a.project2_tab1x,imgTab2:a.project2_tab2x},{skill1:"&num;react",skill2:"&num;js",skill3:"&num;node js",skill4:"&num;git",title:"Programming Across Borders: Ideas, Technologies, Innovations",href:"https://github.com/koleso8/js2team_proj",link:"See project",imgMob1:a.project3_mob1x,imgMob2:a.project3_mob2x,imgTab1:a.project3_tab1x,imgTab2:a.project3_tab2x}],We=document.querySelector(".projects-cards"),f=document.querySelector(".swiper-button-prev"),w=document.querySelector(".swiper-button-next"),k=document.querySelector(".icon-prev"),L=document.querySelector(".icon-next");function He(e){return e.map(t=>`<li class="projects-card swiper-slide">
        ...
        </li>`).join("")}function Ye(e){const t=He(e);We.innerHTML=t}Ye(Oe);document.addEventListener("DOMContentLoaded",()=>{const e=new v(".swiper-container",{slidesPerView:1,spaceBetween:20,grabCursor:!0});function t(){e.isBeginning?(f.classList.add("disabled"),k.classList.add("disabled")):(f.classList.remove("disabled"),k.classList.remove("disabled")),e.isEnd?(w.classList.add("disabled"),L.classList.add("disabled")):(w.classList.remove("disabled"),L.classList.remove("disabled"))}w.addEventListener("click",()=>{e.slideNext(1e3)}),f.addEventListener("click",()=>{e.slidePrev(1e3)}),document.addEventListener("keydown",i=>{i.key==="ArrowRight"?e.slideNext(1e3):i.key==="ArrowLeft"?e.slidePrev(1e3):i.key==="Tab"&&(i.preventDefault(),i.shiftKey?e.slidePrev(1e3):e.slideNext(1e3))}),e.on("slideChange",t),t()});T.create(`
     <div class="container">
     <div class="modal">
...
`,{onShow:e=>{e.element().querySelector("a").onclick=e.close,document.addEventListener("keydown",t=>{t.code==="Escape"&&e.close()}),document.body.style.position="fixed"},onClose:e=>{console.log("onClose",e),document.body.style.position=""}});document.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",function(t){t.preventDefault();const i=document.querySelector(this.getAttribute("href"));if(i){let j=function(c){m===null&&(m=c);const p=c-m,h=z(p,s,o,n);window.scrollTo(0,h),p<n&&requestAnimationFrame(j)},z=function(c,p,h,C){return c/=C/2,c<1?h/2*c*c+p:(c--,-h/2*(c*(c-2)-1)+p)};const r=i.getBoundingClientRect().top+window.pageYOffset,s=window.pageYOffset,o=r-s,n=500;let m=null;requestAnimationFrame(j)}})});let Qe=document.querySelectorAll(".section-animation");function $(){let e=window.innerHeight;Qe.forEach(t=>{t.getBoundingClientRect().top<e-100?(t.style.opacity="1",t.style.transform="translateY(0)"):(t.style.opacity="0",t.style.transform="translateY(0)")})}$();window.addEventListener("scroll",$);const Re=document.querySelector(".theme-red"),De=document.querySelector(".theme-yellow"),Je=document.querySelector(".theme-orange"),Ue=document.querySelector(".theme-green"),Ve=document.querySelector(".theme-blue"),_=document.querySelector("body");function g(e){_.classList="",_.classList.add(e)}Re.addEventListener("click",()=>{g("red"),V()});De.addEventListener("click",()=>{g("yellow"),K()});Je.addEventListener("click",()=>{g("orange"),F()});Ue.addEventListener("click",()=>{g("green"),G()});Ve.addEventListener("click",()=>{g("blue"),X()});
